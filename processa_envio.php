<?php
  ...
  try {
      ...
      $mail->Username = 'seu-email.com';                 // SMTP username
      $mail->Password = 'sua-senha';                           // SMTP password
      $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
      $mail->Port = 587;                                    // TCP port to connect to
 
      //Recipients
      $mail->setFrom('seu-email.com', 'Usuario Remente');
  ...
  <html>
  	<head>
	  	<meta charset="utf-8" />
	    	<title>Aplicativo de envio de e-mail</title>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<? if ($mensagem->status['codigo_status'] == 2) { ?>
						<div class="container">
							<h1 class="display-4 text-danger">Houve um erro!</h1>
							<p><?= $mensagem->status['descricao_status']?></p>
